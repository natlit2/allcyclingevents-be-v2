...
const managedEventsScraper = require("./scrapers/managedEventsScraper");
...
async function runAllScrapers() {
  ...
  try { await managedEventsScraper(); } catch (e) { console.error("Managed events scraper failed:", e.message); }
